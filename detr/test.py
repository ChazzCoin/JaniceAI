...
from datasets.construction import make_coco_transforms
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default="/Users/chazzromeo/Desktop/checkpoints/", help='resume from checkpoint')
